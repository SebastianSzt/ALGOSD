...
int main()
{
    ...
    printf("13 - znajdź wartość najczęściej występującą na liście\n");
    printf("14 - usuń z listy l wszystkie liczby niepodzielne przez k\n");
    printf("15 - odwróć listę iteracyjnie\n");
    printf("16 - odwróć listę rekurencyjnie\n");
    ...
    switch (select)
    {
        ...
        case 13:
        {
            ...
            printf("Lista:\n");
            WyswietlListe(head);
            int MostCommon = findMostCommon(head);
            printf("Wartość najczęściej występującą na liście: %d\n", MostCommon);
            break;
        }
        case 14:
        {
